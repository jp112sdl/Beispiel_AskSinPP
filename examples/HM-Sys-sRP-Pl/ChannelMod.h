...
template<class HalType,class List1Type,class List2Type, class List3Type,class List4Type,int PeerCount,class List0Type=List0>
class Channel {
...
template <class HalType,class List1Type,class List2Type, class List3Type,int PeerCount,class List0Type,class StateMachine>
class ActorChannel : public Channel<HalType,List1Type,List2Type, List3Type,EmptyList,PeerCount,List0Type>, public StateMachine {
public:
  typedef Channel<HalType,List1Type,List2Type, List3Type,EmptyList,PeerCount,List0Type> BaseChannel;
  uint8_t lastmsgcnt;
