...
const struct DeviceInfo PROGMEM devinfo = {
    {0x07,0x5F,0x01},       // Device ID
    "JPSCI30001",           // Device Serial
...
class RHSType : public ThreeStateDevice<Hal,ChannelType,3,RHSList0,CYCLETIME> {
public:
  typedef ThreeStateDevice<Hal,ChannelType,3,RHSList0,CYCLETIME> TSDevice;
...
void setup () {
  ...
  sdev.channel(2).init(SENS2_PIN,SENS2_PIN,posmap);
  sdev.channel(3).init(SENS3_PIN,SENS3_PIN,posmap);
  sdev.initDone();
}
